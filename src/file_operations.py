...
def load_unit_body_corp(file_path): # Reference file of body corporate
    """
...
def save_body_corp(file_path, body_corporate):
    """
    Save information of body corporate payments in a JSON file.
    (parameters) file_path: path to JSON file, body_corporate: list of body corporate payments
